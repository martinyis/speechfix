...
import { IrisRingOrb } from '../../components/orbs/IrisRingOrb';
...
export default function IntroAgentScreen() {
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top, paddingBottom: insets.bottom }]}>
      ...
      {/* Iris Ring Orb — flex:1 fills available space, pushes text to bottom */}
      <View style={styles.orbSection}>
        <IrisRingOrb state={isPlaying ? 'speaking' : 'idle'} />
      </View>
