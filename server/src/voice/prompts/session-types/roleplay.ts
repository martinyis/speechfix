...
export const ROLEPLAY_BEHAVIOR_PROMPT = `Keep responses SHORT. 1-3 sentences. Spoken conversation.
Speak naturally in whatever register fits your character (formal, casual, professional, etc.).
...
GREETING: Begin as your character would naturally open the interaction. Do NOT introduce yourself or explain the scenario. Just start. One sentence, maybe two.
